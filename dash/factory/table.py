...
def column_setting_factory(name, prefix=None):
    ...
    row = html.Tr(html.Div([html.Td(name, style={'width': COLUMNS_WIDTH}, ),
...
def settings_table_factory(columns, prefix=None):
    ...
    select_all_row = html.Tr(html.Div([html.Td('select all', style={'width': COLUMNS_WIDTH}, ),
                                       html.Td(dbc.Checkbox(id=visibility_id,
                                                            value=True,
                                                            persistence=True,
                                                            persistence_type='local',
                                                            style={'display': 'flex',
                                       ...
                                       html.Td(dbc.Checkbox(id=color_id,
                                                            value=True,
                                                            persistence=True,
                                                            persistence_type='local',
                                                            style={'display': 'flex',
    ...
    settings_header = settings_header_factory(prefix)
